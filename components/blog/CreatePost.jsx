...
function CreatePost() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="max-h-[98dvh] w-full max-w-4xl overflow-y-scroll rounded-sm bg-white p-6 shadow-lg">
        ...
        <form className="space-y-4 rounded-md">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-500">
              Select multiple images to use in your post content (local preview
              only)
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mt-1 text-xs">
              Supports Markdown and HTML. Use &lt;img&gt; tags for precise image
              sizing.
            </p>
          </div>
